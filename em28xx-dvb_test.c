...
static struct lgs8gxx_config em2874_lgs8gl5_cfg = {
...
unsigned char ida_em2874_lgs8gl5_cfg[] =
{
  0x04, 0x19, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x76, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 
  0x00, 0x61, 0x00, 0x00
};
...
static struct admtv102_config dcdtv_350_config = {
	.i2c_address = 0x61,
	.ref_clk_type=0x06,
};
...
static int em28xx_dvb_init(struct em28xx *dev)
{
	...
	case EM2874_BOARD_LEADERSHIP_ISDBT:
		...
		// if (!dvb->fe[0]) {
			...
			// goto out_free;
		// }
		memcpy(&em2874_lgs8gl5_cfg, ida_em2874_lgs8gl5_cfg,24);
		em28xx_errdev("load lgs8gxx driver\r\n");
		dvb->fe[0] = dvb_attach(lgs8gxx_attach,
					   &em2874_lgs8gl5_cfg,
					   &dev->i2c_adap);
					   
		if (dvb->fe[0] != NULL)
		{
			em28xx_errdev("load adimtv102 driver\r\n");
			dvb_attach(admtv102_attach, dvb->fe[0], 
				   &dev->i2c_adap, &dcdtv_350_config);
		}
		break;
	...
	case EM2870_BOARD_KWORLD_A340:
		...
		break;
	case EM2874_BOARD_DCDTV350_DTMB://修改
		memcpy(&em2874_lgs8gl5_cfg, ida_em2874_lgs8gl5_cfg,24);
		dvb->fe[0] = dvb_attach(lgs8gxx_attach,
					   &em2874_lgs8gl5_cfg,
					   &dev->i2c_adap);
		...
		if (dvb->fe[0] != NULL)
		{
			em28xx_errdev("load tuner driver\r\n");
			dvb_attach(tda18271_attach, dvb->fe[0], 0x60,//admtv102_attach
				   &dev->i2c_adap, &kworld_a340_config);
		}		   
		break;		
